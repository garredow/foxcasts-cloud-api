...
> = {
  ...
  podexId?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
...
> {
  Podcast?: {
    id?: LoaderResolver<Maybe<Scalars['ID']>, Podcast, {}, TContext>;
    title?: LoaderResolver<Scalars['String'], Podcast, {}, TContext>;
    podexId?: LoaderResolver<Scalars['Int'], Podcast, {}, TContext>;
  };
}
